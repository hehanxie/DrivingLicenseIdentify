...
###2018-05-03
##Fixed
- 改进colorMatch函数，经过测试案例可准确定位红色区域
- 修改字符分割算法，通过设定阈值，提高字符划分的准确度

---

###2018-04-06
##Fixed
- 对WordDivide函数进行修改，使切割字符时准确性更高，避免过多的划分
— 对涉及Vector的函数进行修改，不实用嵌套下的Vector，避免逻辑混乱
