...
int main()
{
	string Path = "/Users/Wihan/Documents/Projects/Git/DrivingLicense/exampleImage/";
	string str = "";
	for (int i = 1; i <=1; i++)
	{
		Path = "/Users/Wihan/Documents/Projects/Git/DrivingLicense/exampleImage/";
		str = std::to_string(i);
		Path = Path + str + ".jpg";
...
//		cout << "source image size: " << srcImage.cols << " x " << srcImage.rows << endl;
		...
		system("python /Users/Wihan/Documents/Projects/Git/DrivingLicense/Tesseract.py");
	}

//	Mat srcImage = imread("/Users/Wihan/Documents/Projects/Git/DrivingLicense/exampleImage/1.jpg");
//	if (srcImage.empty())
//	{
//		cout << "error";
//		return -1;
